...
Digital trial platforms are pivotal in addressing the unique challenges posed by ADRD conditions. These platforms are designed to facilitate the complexities of conducting clinical trials in populations affected by cognitive impairments, ensuring that studies are efficient, patient-friendly, and yield high-quality data.  These may be used for remote recruitment, publishing remote survey instruments, remote consent collections, etc. For example, the Care Evolution Platform provides data collection for up to 100 users. ClinOne offers a suite of technologies to support clinical trial management, including patient recruitment, e-consent, and remote patient monitoring. REDCap, Castor EDC also provides remote data collection through survey instruments and e-consent.
